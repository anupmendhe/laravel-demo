...
$(document).ready(function () {
  ...
  var barChartOptions = {
    ...
    xaxis: {
      categories: ['Sep-19', 'Oct-19', 'Nov-19', 'Dec-19', 'Jan-20', 'Feb-20', 'Mar-20', 'Apr-20', 'May-20', 'June-20', 'July-20', 'Aug-20'],
      tickAmount: 5
    },
    yaxis: {
      opposite: yaxis_opposite
  ...
  var donutChartOptions = {
    ...
    colors: themeColors,
       labels: ['Sboba Orders', 'Chef Orders', 'Pickup Orders', 'Cancelled Orders'],
    series: [20, 40, 45, 15],
    legend: {
      itemMargin: {
        horizontal: 2
